...
in
{
  ...
  system.defaults = {
    ...
    CustomUserPreferences = {
      ...
      # macSKK handles this only while its input source is active. Use the
      # physical Command+J chord for the Hiragana reset without changing
      # Command shortcuts in other applications.
